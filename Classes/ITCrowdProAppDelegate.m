...
#import "ITCrowdProAppDelegate.h"
...
@implementation ITCrowdProAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {    
	...
	AboutUsController *aboutUsViewController = [[AboutUsController alloc] init];
	UINavigationController *fifthViewNavController = [[UINavigationController alloc] initWithRootViewController:aboutUsViewController];
	
	//Add view controllers as children of tabBarController
	tabBarController.viewControllers = [NSArray arrayWithObjects:firstViewNavController,thirdViewNavController, fifthViewNavController,secondViewNavController,fourthViewNavController,nil];
	...
	[fifthViewNavController release];
